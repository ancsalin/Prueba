...
def transformar_audio_en_texto():
    ...
    with sr.Microphone() as origen:
        ...
        #En caso de no se comprenda el audio
        except sr.UnknownValueError:

            #Prueba de no comprendo el audio
...
def pedir_dia():
    ...
    #diccionario que contengo los nombres de los dias
    calendario = {0: 'Lunes',
                  1: 'Martes',
                  2: 'Miercoles',
                  3: 'Jueves',
...
def saludo_inicial():
    ...
    # Crear variable con datod de hora
    hora = datetime.datetime.now()
    ...
    #decir el saludo
    hablar(f'{momento}, soy Sabina , tu asistente personal. Dime en que te puedo ayudar ')
...
def pedir_cosas():
    ...
    while comenzar:
        ...
        if  'abrir youtube' in pedido:
            hablar('Con gusto , lo estoy abriendo')
            webbrowser.open('https://www.youtube.com')
            continue
        elif 'abrir navegador' in pedido:
             hablar('Claro ya te ayudo')
             webbrowser.open('https://www.google.com')
             continue
        elif 'Dime que dia es hoy' in pedido:
             pedir_dia()
             continue
        elif 'Dime que hora es' in  pedido:
             pedir_hora()
             continue
            ...
            hablar('Buena idea, ya lo comienzo a reproducirlo ')
